...
public class SDKClientProxy implements com.sipai.emsg.SDKClient {
  private String _endpoint = null;
  private com.sipai.emsg.SDKClient sDKClient = null;
  ...
  private void _initSDKClientProxy() {
    try {
      sDKClient = (new com.sipai.emsg.SDKServiceLocator()).getSDKService();
      if (sDKClient != null) {
        if (_endpoint != null)
  ...
  public com.sipai.emsg.SDKClient getSDKClient() {
    if (sDKClient == null)
      _initSDKClientProxy();
    return sDKClient;
  }
