...
<script type="text/javascript">
	...
	$(function() {
		...
		//				{width : '60', title : '完成数', field : 'finishedquantity',halign:'center' ,sortable:false}, 
						...
						{title : '操作', field : 'action', width : '60', halign:'center', align:'center', formatter : function(value, row) {
								var str = '';
...
<!-- 					<a href="javascript:void(0);"  class="ext-icon-package_add" title="新增物料计划单"	 onclick="planordermaterialadd('${dailyplansummary.id}');"></a> -->
<!-- 					<%}%> -->--%>	
										...
										<td>
											<table>
												<tr>
													...
													<a href="javascript:void(0);"  class="easyui-linkbutton" data-options="iconCls:'ext-icon-status_away',plain:true"  onclick="doaudit();">全部审核</a>
													<%}%>
													</td>
													<td id="disttd" name="distttd" >	
													<%if (sessionManager.havePermission(session,"plan/dailyplan/distribute.do")) {%>	
													<a href="javascript:void(0);"  class="easyui-linkbutton" data-options="iconCls:'ext-icon-table_go',plain:true" 	 onclick="distributeday();">全部下发</a>
													<%}%>
													</td>
												</tr>
											</table>
...
<!-- 															onclick="$('#searchForm').form('clear');ddvpid='';grid.datagrid('load',{});">全部计划</a> -->
		...
		<div title="已作废计划" data-options="iconCls:''" style="padding:0px;">
