...
<body>
		<form method="post" class="form">
			<table class="table">
				...
				<tr>
						<th >接收角色</th>
						<td ><input id="msgrole-name" name="msgrole-name" class="easyui-textbox"	data-options="prompt:'内容空默认全部',multiline:true,readonly:true" style="overflow:auto;width:100%;height:80px;" value="" />
						<input id="msgroleids" name="msgroleids" type="hidden" value=""></td>
						<script type="text/javascript">
						$(function() {							
				...
				<tr>
						<th >消息发送用户</th>
						<td ><input id="msguser-name" name="msguser-name" class="easyui-textbox"	data-options="prompt:'内容空默认全部',multiline:true,readonly:true" style="overflow:auto;width:100%;height:80px;" value="" />
				...
				<tr>
						<th >短信发送用户</th>
						<td ><input id="smsuser-name" name="smsuser-name" class="easyui-textbox"	data-options="prompt:'内容空默认全部',multiline:true,readonly:true" style="overflow:auto;width:100%;height:80px;" value="" />
				...
				<tr>
					...
					<td >
						<select id="sendway" name="sendway" class="easyui-combobox" style="width:152px;">
							<option value='msg' select>仅消息发送</option>
				...
				<tr>
						<th >备注</th>
						<td ><input id="remark" name="remark" class="easyui-textbox"	data-options="multiline:true" style="overflow:auto;width:100%;height:80px;" value=""validtype="length[0,250]" invalidMessage="有效长度0-250" />
						</td>								
				</tr>					
			</table>
		</form>
