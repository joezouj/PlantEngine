			...
			<table class="table">
				...
				<tr>
					...
					<td><input id="capacity" name="capacity" class="easyui-numberbox"
						...
						data-options="required:true,validType:'isBlank'" value="${line.capacity}" autofocus/>
					</td>
				</tr>
				<tr>
					<th>备注</th>
					<td>
						<textarea name="remark" class="easyui-textbox" data-options="multiline:true" style="height:100px;width:100%" validtype="length[0,250]" invalidMessage="有效长度0-250">${line.remark}</textarea>
					</td>
				</tr>
			</table>
		</form>
