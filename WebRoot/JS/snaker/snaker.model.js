...
$.extend(true,snakerflow.config.props.props,{
	name : {name:'name', label:'工艺名称', value:'', editor:function(){return new snakerflow.editors.inputEditor();}},
...
$.extend(true,snakerflow.config.tools.states,{
			...
			task : {
				...
				props : {
					name: {name:'name',label: '工序名称', value:'', editor: function(){return new snakerflow.editors.inputEditor();}},
			...
			custom : {
				...
				props : {
					...
					displayName: {name:'displayName',label: '显示名称', value:'', editor: function(){return new snakerflow.editors.textEditor();}, value:'自定义'},
			...
			subprocess : {
				...
				props : {
					name: {name:'name',label: '名称', value:'', editor: function(){return new snakerflow.editors.inputEditor();}},
					displayName: {name:'displayName',label: '显示名称', value:'', editor: function(){return new snakerflow.editors.textEditor();}, value:'子流程'},
			...
			decision : {
				...
				props : {
					name: {name:'name',label: '名称', value:'decision', editor: function(){return new snakerflow.editors.inputEditor();}},
			...
			fork : {
				...
				name : {text:'<<fork>>'},
				text : {text:'fork'},
				img : {src : 'images/48/gateway_parallel_red.png',width :48, height:48},
				props : {
					name: {name:'name',label: '名称', value:'fork', editor: function(){return new snakerflow.editors.inputEditor();}},
				    preInterceptors: {name:'preInterceptors', label : '前置拦截器', value:'', editor: function(){return new snakerflow.editors.inputEditor();}},
					postInterceptors: {name:'postInterceptors', label : '后置拦截器', value:'', editor: function(){return new snakerflow.editors.inputEditor();}}
				}},
			join : {
				...
				name : {text:'<<join>>'},
				text : {text:'join'},
				img : {src : 'images/48/gateway_parallel_green.png',width :48, height:48},
				props : {
					name: {name:'name',label: '名称', value:'join', editor: function(){return new snakerflow.editors.inputEditor();}},
				    preInterceptors: {name:'preInterceptors', label : '前置拦截器', value:'', editor: function(){return new snakerflow.editors.inputEditor();}},
					postInterceptors: {name:'postInterceptors', label : '后置拦截器', value:'', editor: function(){return new snakerflow.editors.inputEditor();}}
				}}
});
